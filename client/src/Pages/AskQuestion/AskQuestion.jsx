...
const AskQuestion = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        console.log({userPosted: User.result.name})
        ...
        <form onSubmit={handleSubmit}>
            <div className="ask-form-container">
                ...
                <label htmlFor="ask-ques-tags">
                    ...
                    <input type="text" id="ask-ques-tags" onChange={(e) => {setQuestionTags(e.target.value.split(" "))}}  placeholder='e.g. is (XML typescript wordpress)'/>
                </label>
            </div>
